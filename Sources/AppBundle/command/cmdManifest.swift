...
extension CmdArgs {
    func toCommand() -> any Command {
        ...
        switch Self.info.kind {
            ...
            case .centerColumn:
                command = CenterColumnCommand(args: self as! CenterColumnCmdArgs)
            case .close:
            ...
            case .setColumnWidth:
                command = SetColumnWidthCommand(args: self as! SetColumnWidthCmdArgs)
            case .toggleScrollFocusAlignment:
                command = ToggleScrollFocusAlignmentCommand(args: self as! ToggleScrollFocusAlignmentCmdArgs)
            case .subscribe:
