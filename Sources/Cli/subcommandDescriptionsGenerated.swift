...
let subcommandDescriptions = [
    ...
    ["  center-column", "Center the focused column in a scrolling workspace"],
    ...
    ["  move-column", "Move the focused column in a scrolling workspace"],
    ...
    ["  scroll", "Scroll a scrolling workspace to an adjacent column"],
    ["  set-column-width", "Set the focused scrolling column width"],
    ...
    ["  toggle-scroll-focus-alignment", "Toggle scrolling focus alignment between center, leading, and trailing"],
