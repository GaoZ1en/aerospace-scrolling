public enum CmdKind: String, CaseIterable, Equatable, Sendable {
    ...
    case toggleScrollFocusAlignment = "toggle-scroll-focus-alignment"
    case subscribe
...
func initSubcommands() -> [String: any SubCommandParserProtocol] {
    ...
    for kind in CmdKind.allCases {
        switch kind {
            ...
            case .centerColumn:
                result[kind.rawValue] = SubCommandParser(CenterColumnCmdArgs.init)
            case .close:
            ...
            case .setColumnWidth:
                result[kind.rawValue] = SubCommandParser(parseSetColumnWidthCmdArgs)
            case .toggleScrollFocusAlignment:
                result[kind.rawValue] = SubCommandParser(ToggleScrollFocusAlignmentCmdArgs.init)
            case .subscribe:
