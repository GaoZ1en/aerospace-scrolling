...
let balance_sizes_help_generated = """
    ...
    """
let center_column_help_generated = """
    USAGE: center-column [-h|--help]
    """
...
let move_column_help_generated = """
    USAGE: move-column [-h|--help] (left|right)
    """
...
let scroll_help_generated = """
    ...
    """
let set_column_width_help_generated = """
    USAGE: set-column-width [-h|--help] (reset|<points>|<percent>%|[+|-]<percent>%)
    """
...
let test_help_generated = """
    USAGE: test [-h|--help] <lhs> .= <rhs>
       ...
       OR: test [-h|--help] <lhs> /~ <rhs>
    """
let toggle_scroll_focus_alignment_help_generated = """
    USAGE: toggle-scroll-focus-alignment [-h|--help]
    """
