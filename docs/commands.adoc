...
== center-column
----
include::aerospace-center-column.adoc[tags=synopsis]
----
include::aerospace-center-column.adoc[tags=purpose]
include::aerospace-center-column.adoc[tags=body]
...
== move-column
----
include::aerospace-move-column.adoc[tags=synopsis]
----
include::aerospace-move-column.adoc[tags=purpose]
include::aerospace-move-column.adoc[tags=body]
...
== set-column-width
----
include::aerospace-set-column-width.adoc[tags=synopsis]
----
include::aerospace-set-column-width.adoc[tags=purpose]
include::aerospace-set-column-width.adoc[tags=body]
